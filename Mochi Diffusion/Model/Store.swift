...
final class GeneratorStore: ObservableObject {
    ...
    func importImages() {
        ...
        panel.message = "Choose generated images to import"
        panel.prompt = "Import"
        ...
        let alert = NSAlert()
        alert.messageText = "Successfully imported \(succeeded) images"
        if failed > 0 {
            alert.informativeText = "\(failed) images were not imported. Only images generated by Mochi Diffusion 2.1.6 or newer can be imported."
        }
