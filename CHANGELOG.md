...
- Added support for FLUX.2 Klein models (4B & 9B) ([@gdbing](https://github.com/gdbing))
   - Model must be a diffusers style folder containing `transformer`, `text_encoder`, `vae`, & `tokenizer`
...
# [v5.2](https://github.com/MochiDiffusion/MochiDiffusion/releases/tag/v5.2) - 29 Oct 2024

- Added support for Stable Diffusion 3 models ([@ZachNagengast](https://github.com/ZachNagengast))
   - Model must have `MultiModalDiffusionTransformer.mlmodelc` file and uses the Flow Match Euler Discrete scheduler
- Added advanced filter field to filter the gallery by prompt, Exclude from Image, model, seed, steps, or guidance scale ([@hoseins77](https://github.com/hoseins77))
- Added ability to tag gallery images with colored emoji from the right click menu, stored as Finder tags ([@jupdike](https://github.com/jupdike))
- Updated translations


# [v5.1](https://github.com/MochiDiffusion/MochiDiffusion/releases/tag/v5.1) - 16 Mar 2024

- Added button to view models in Finder ([@alexey-detr](https://github.com/alexey-detr))
- Fixed token counter to match the currently selected model ([@gdbing](https://github.com/gdbing))
