...
final class GeneratorStore: ObservableObject {
    ...
    func importImages() {
        ...
        let alert = NSAlert()
        alert.messageText = String(localized: "Successfully imported \(succeeded) image(s)")
        if failed > 0 {
            alert.informativeText = String(localized: "\(failed) image(s) were not imported. Only images generated by Mochi Diffusion 2.1.6 or newer can be imported.")
        }
