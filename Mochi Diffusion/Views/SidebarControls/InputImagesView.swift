...
struct InputImagesView: View {
    ...
    private var visibleWellCount: Int {
        let filledCount = min(controller.inputImages.count, controller.maxInputImageCount)
...
private struct InputImageRow: View {
    ...
    private var hasImage: Bool {
        index < controller.inputImages.count
    }
...
private struct InputImageEditPopover: View {
    ...
    private var sourceImage: CGImage? {
        guard index < controller.inputImages.count else { return nil }
        return controller.inputImages[index].image
    }
